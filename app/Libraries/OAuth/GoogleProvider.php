...
class GoogleProvider extends AbstractProvider
{
    ...
    /**
     * Enforce the security-critical ID token claims: issuer, audience (our
     * client id), and expiry. This is what prevents accepting a token minted
     * for a different app or a replayed/expired one.
     *
