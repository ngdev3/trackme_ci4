...
class ApiRegistry
{
    ...
    private const PARAMS = [
        ...
        'GET inventory/reports/{param}' => ['path' => ['report (daybook|stock|...)'], 'query' => ['from?', 'to?']],
        'POST inventory/inward'       => ['body' => ['product_id', 'qty', 'warehouse_id', 'party_id?', 'rate?']],
        'POST inventory/outward'      => ['body' => ['product_id', 'qty', 'warehouse_id', 'party_id?', 'rate?']],
