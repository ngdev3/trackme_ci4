 ...
 */
$ready = ['dashboard', 'notification', 'users', 'role_permissions', 'user_permissions', 'invoice', 'seo', 'hsn', 'profile', 'help', 'attachments', 'app_setting', 'entry_trace', 'menu_order', 'item_master', 'web_push', 'account_name', 'gst_setting', 'ricemill_inquiry', 'billing_register', 'traffic', 'device', 'document', 'letter_pad'];
